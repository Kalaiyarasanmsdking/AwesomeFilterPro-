...
async def next_page(bot, query):
    ...
    btn.insert(1, 
        [
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/kalaimovierequest'),
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ', url='http://t.me/KalaiAdmin_Bot')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs 🤖', url='https://t.me/Kalaibots'),
            InlineKeyboardButton('💥 ᴍᴏᴠɪᴇs ♥️', url='https://t.me/KalaiMoviesLinkZz')
            ],[
            InlineKeyboardButton('💞 sᴜᴘᴘᴏʀᴛ 💞', url='https://t.me/Kalaibots'),
            InlineKeyboardButton('👩‍💻 ʀᴇᴘᴏ ✨', url='http://t.me/KalaiAdmin_Bot'),
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('🙄 ᴏᴡɴᴇʀ 🙄', url='https://t.me/MsdKalai07'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs 🤖', url='https://t.me/Kalaibots'),
        ],[
            InlineKeyboardButton('👩‍💻 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 👩‍💻', url='http://t.me/KalaiAdmin_Bot'), #Please Change your bot username
